...
require('lazy').setup({
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      -- Usage: Type your search query, then two spaces, then the file glob pattern
      -- Example: "function  *.lua" searches for "function" in all .lua files
      -- Example: "TODO  *.md" searches for "TODO" in all .md files
